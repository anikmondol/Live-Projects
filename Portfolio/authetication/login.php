                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="login_post.php" method="post">
                        ...
                        <div>
                            ...
                            <input type="password" name="password" id="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 <?= (isset($_SESSION["password_error"])) ? "placeholder-red-600 border border-red-600" : ""; ?>" value="<?= (isset($_SESSION["successful_password"])) ? $_SESSION["successful_password"] : "";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            unset($_SESSION["successful_password"]); ?>">
