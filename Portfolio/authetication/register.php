                ...
                <div class="card bg-orange-100 w-full max-w-sm shrink-0 shadow-2xl py-1">
                    <form action="register_post.php" method="post" class="card-body">
                        ...
                        <div class="input input-bordered flex items-center gap-2">
                            ...
                            <input name="username" type="text" class="grow" placeholder="Username" value="<?= (isset($_SESSION["old_name"])) ?  $_SESSION["old_name"] : "";
                        ...
                        <div class="input input-bordered flex items-center gap-2">
                            ...
                            <input name="email" type="text" class="grow" placeholder="Email" value="<?= (isset($_SESSION["old_email"])) ?  $_SESSION["old_email"] : "";
                        ...
                        <div>
                            <div class="input input-bordered flex items-center gap-2">
                                ...
                                <input id="myInput" name="password" type="password" placeholder="Password" class=" grow" value="<?= (isset($_SESSION["old_password"])) ?  $_SESSION["old_password"] : "";
