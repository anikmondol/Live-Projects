...
<div class="min-h-screen bg-blue-50">
    <section class="flex flex-col bg-white py-4">
        <div class="flex flex-row space-x-3">
            <h3 class="font-bold text-gray-600 p-1 text-2xl">Educations</h3>
        </div>
        <div>
    ...
    <section class="mt-3 p-3 w-full lg:w-10/12 mx-auto">
        <div style="overflow-y: scroll; height: 400px;">
            <div class="flex justify-between items-center">
                <h5 class="text-xl font-medium">educations</h5>
                <div>
                    <a href="./create.php">
                        <button type="submit" name="educations_btn" class="btn btn-primary my-3"><i class="fa-solid fa-plus" style="color: #ffffff"></i>Create</button>
                    </a>
                </div>
            </div>
            <table class="table table-xs border border-gray-300">
                <thead>
                    <tr class="border-b border-gray-300 bg-cyan-300">
                        ...
                        <th class="border text-base border-gray-300">Year</th>
                        <th class="border text-base border-gray-300">Ration</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="border-b border-gray-300">
                            ...
                            <td class="border text-base border-gray-300">
                                <a href="store.php?status_id=<?= $education['id'] ?>" class="p-1 rounded-sm text-white <?= ($education['status'] == 'deactive') ? 'bg-red-400' : 'bg-green-400'; ?>">
                                    <?= $education['status'] ?>
                                </a>
                            </td>
                            <td class="border text-base border-gray-300">
