...
<div class="min-h-screen bg-blue-50">
    <section class="flex flex-col bg-white py-4">
        <div class="flex flex-row space-x-3">
            <h3 class="font-bold text-gray-600 p-1 text-2xl">Feedback Page</h3>
        </div>
        <div>
    ...
    <section class="mt-3 p-3 w-full lg:w-10/12 mx-auto">
        <div style="overflow-y: scroll; height: 400px;">
            <div class="flex justify-between items-center">
                <h5 class="text-xl font-medium">Feedback</h5>
                <div>
                    <a href="./create.php">
                        <button type="submit" name="feedbacks_btn" class="btn btn-primary my-3"><i class="fa-solid fa-plus" style="color: #ffffff"></i>Create</button>
                    </a>
                </div>
            </div>
