    ...
    <div class="flex flex-col md:flex-row">
        ...
        <nav class="flex flex-col bg-gray-50 h-screen justify-between md:w-2/6 lg:w-1/6">
            ...
            <div class="flex flex-col flex-auto gap-4 md:gap-5 mx-3">
                <div class="p-3 px-5 hover:bg-green-200 rounded bg-slate-100">
                    <div class="flex flex-row space-x-3 items-center">
                        ...
                        <h1 class="font-medium text-gray-700 text-sm lg:text-xl">Dashboard</h1>
                    </div>
                </div>
                <div class="p-3 px-5 hover:bg-green-200 rounded bg-slate-100">
                    <div class="flex flex-row space-x-3 items-center">
                        ...
                        <h1 class="font-medium text-gray-700 text-sm lg:text-xl">Home</h1>
                    </div>
                </div>
                <div class="p-3 px-5 hover:bg-green-200 rounded bg-slate-100">
                    <div class="flex flex-row space-x-3 items-center">
                        ...
                        <h1 class="font-medium text-gray-700 text-sm lg:text-xl">Scrives</h1>
                    </div>
                </div>
                <div class="flex justify-center mx-auto mb-3">
                    <a href="../logout/logout.php">
                    <button class="bg-red-400 text-slate-200 font-semibold px-7 md:px-16 py-4 lg:py-5 rounded-lg hover:bg-orange-400 hover:text-white">Logout <i class="fa-solid fa-arrow-right-from-bracket"></i></button>
                    </a>
                </div>
            </div>
