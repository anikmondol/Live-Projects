                ...
                <form action="store.php?edit_id=<?= $portfolio['id'] ?>" method="post" enctype="multipart/form-data">
                        <div class="lg:w-[800px] px-2">
                            <div>
                                ...
                                <br>
                                <div>
                                    <input type="text" name="title" placeholder="Type here" class="input input-bordered w-[300px] md:w-[400px] lg:w-[760px]  my-4" value="<?= $portfolio['title'] ?>" />
                                </div>
                            </div>
                            <div>
                                ...
                                <br>
                                <div>
                                    <input type="text" name="subtitle" placeholder="Type here" class="input input-bordered w-[300px] md:w-[400px] lg:w-[760px]  my-4" value="<?= $portfolio['subtitle'] ?>" />
                                </div>
                            </div>
                            <div>
