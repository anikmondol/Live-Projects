...
<body>
    ...
    <main>
        ...
        <section class="xl:max-w-[1280px] mx-auto py-5 lg:py-16 px-4 md:px-8 lg:px-0">
            <hr class="text-white">

            <div class="my-5 flex justify-between items-center flex-col md:flex-row">
                <h2 class="text-[#FFFFFF] text-4xl font-semibold">Share On</h2>
        ...
        <section id="auther" class="xl:max-w-[1280px] mx-auto py-5 lg:py-16 px-4 md:px-8 lg:px-0">
            <div class="flex items-center gap-5 text-white">
                ...
                <div class="">
                    <h2 class="text-xl font-medium">New movie is released!</h2>
                    <p class="text-[#8792AB] font-medium">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Incidunt, eos iure! Nesciunt maiores delectus ducimus labore mollitia at ut, possimus cum explicabo consectetur sapiente omnis modi totam quas porro dignissimos?</p>
                    <div class="my-5 flex flex-row gap-2">
                        <a href="" target="_blank">
                            <button type="button"
                                class="text-cyan-400 border-2 border-[#8CC090] hover:border-red-500 hover:text-white rounded-full px-4 py-3 text-center duration-500">
