...
if (isset($_POST['password_btn'])) {
    ...
    if (!$old_password) {
        ...
        $_SESSION["old_password_update"] = "Old Password done !!!";
        $flag = true;
        header("location: profile.php");
    }
    ...
    if (!$new_password) {
        ...
        $_SESSION["new_password_update"] = "New Password done!!!";
        $flag = true;
        header("location: profile.php");
    }
    ...
    if (!$confirm_password) {
        ...
        $_SESSION["confirm_update"] = "Confirm Password done!!!";
        $flag = true;
        header("location: profile.php");
    }
    ...
    if ($flag) {
        if ($old_password && $new_password && $confirm_password) {
            ...
            $connect = mysqli_query($connect_db, $old_pass_query);
